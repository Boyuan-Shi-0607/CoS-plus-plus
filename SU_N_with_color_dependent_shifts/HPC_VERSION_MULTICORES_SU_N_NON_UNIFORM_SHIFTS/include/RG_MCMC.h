...
namespace RG_MCMC {
    ...
    // Tunables / constants
    // =========================
    constexpr Real P_GAUSSIAN  = 0.5;
    constexpr Real P_UNIFORM   = 0.1;
    constexpr Real P_HISTOGRAM = 0.4;

    constexpr int  TRACKED_DIMENSION         = 8;
    constexpr unsigned long long TRACK_EVERY = 4000;
    ...
    inline std::vector<int> VEGAS_SIGN_HIST_DIMS = {6, 7, 8}; // which dims to record
